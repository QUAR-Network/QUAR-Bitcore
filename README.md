...
[![NPM Package](https://img.shields.io/npm/v/bitcore.svg?style=flat-square)](https://www.npmjs.org/package/bitcore-QUAR)
[![Build Status](https://img.shields.io/travis/bitpay/bitcore.svg?branch=master&style=flat-square)](https://travis-ci.org/QUAR-Network/QUAR-bitcore)

Infrastructure to build Bitcoin and blockchain-based applications for the next generation of financial technology.

**Note:** If you're looking for the QUAR-bitcore Library please see: https://github.com/QUAR-Network/QUAR-bitcore
...
```js
var bitcore = require('bitcore-QUAR');
